...
public class Rectangle extends RegularShape {
    public Rectangle(IClient client, int x1, int y1, int x2, int y2, Color color, boolean isFilled) throws RemoteException {
        super(client, x1, y1, x2, y2, color, isFilled, Constants.Shape_Type_Rectangle);
    }
